...
def go(args):
    ...
    # Step 6: TODO
    # ENTER CODE HERE
    #== add longitude and latitude filter ==
    idx = (
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Fully-qualified name of the output artifact in W&B",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "This is the type of the output artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "This is a description of the output artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "This is the minimum price to consider when filtering the dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "This is the maximum price to consider when filtering the dataset",
        required = True
    )
